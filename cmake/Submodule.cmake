...
#    file(REMOVE_RECURSE ${${PROJECT_NAME}_SOURCE_DIR}/.git/modules/extern/${NAME})
#
...
#
#        # 这时候是一个无效rep，删除旧的directory，重新download
##        if (EXISTS ${${PROJECT_NAME}_SOURCE_DIR}/extern/${NAME})
##            file(REMOVE_RECURSE ${${PROJECT_NAME}_SOURCE_DIR}/extern/${NAME})
##        endif ()
#
#        execute_process(
...
#            message(WARNING "git submodule add ${REP_URL} extern/${NAME} failed with ${RESULT}")
